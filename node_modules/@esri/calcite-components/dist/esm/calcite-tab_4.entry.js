 ...
 * v2.7.1
 */
import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, e as readTask, F as Fragment } from './index-28d8549d.js';
import { A as nodeListToArray, k as focusElementInGroup, g as getElementDir, B as filterDirectChildren, t as toAriaBoolean } from './dom-bef18e4a.js';
...
import { a as calciteSize24, b as calciteSize32, d as calciteSize44 } from './core-890e7ced.js';
import { C as CSS_UTILITY } from './resources-25959fe9.js';
import { c as connectInteractive, d as disconnectInteractive, I as InteractiveContainer, u as updateHostInteraction } from './interactive-583e13d7.js';
...
const TabNav = class {
    ...
    render() {
        ...
        return (h(Host, { role: "tablist" }, h("div", { class: {
            ...
            ref: this.storeContainerRef }, this.renderScrollButton("start"), h("div", { class: {
                [CSS$1.tabTitleSlotWrapper]: true,
            }, onScroll: this.onTabTitleScroll, onWheel: this.onTabTitleWheel,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeTabTitleWrapperRef }, h("slot", { onSlotchange: this.onSlotChange })), h("div", { class: {
