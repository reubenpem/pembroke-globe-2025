...
import { b as slotChangeHasAssignedElement, t as toAriaBoolean } from './dom-bef18e4a.js';
...
const Chip = class {
    ...
    render() {
        ...
        return (h(Host, null, h(InteractiveContainer, { disabled: disabled }, h("div", { "aria-checked": this.selectionMode !== "none" && this.interactive
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: (el) => (this.containerEl = el) }, this.selectionMode !== "none" && this.renderSelectionIcon(), this.renderChipImage(), this.icon && this.renderIcon(), h("span", { class: CSS.title }, h("slot", { onSlotchange: this.handleDefaultSlotChange })), this.closable && this.renderCloseButton()))));
    }
