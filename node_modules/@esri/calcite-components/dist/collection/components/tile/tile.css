 ...
 * Generated on Sat, 30 Mar 2024 00:35:51 GMT
 */
/**
 * Do not edit directly
 * Generated on Sat, 30 Mar 2024 00:35:51 GMT
...
/**
 * Do not edit directly
 * Generated on Sat, 30 Mar 2024 00:35:48 GMT
 */
/* mixins & extensions */
...
:host .large-visual calcite-icon {
  block-size: 64px;
  inline-size: 64px;
}
...
:host([scale=s]) .content-container {
...
:host([scale=l]) .content-container {
...
:host(:not([embed])) .container {
  box-shadow: 0 0 0 1px var(--calcite-tile-border-color);
  padding: var(--calcite-spacing-md);
}

:host(:not([embed])[scale=s]) .container {
  padding: var(--calcite-spacing-sm);
}

:host(:not([embed])[scale=l]) .container {
...
:host(:not([embed])[href]:hover) .container,
:host(:not([embed])[href]:focus) .container {
...
:host(:not([embed])[href]:active) .container {
