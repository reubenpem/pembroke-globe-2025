...
const CardGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("div", { "aria-disabled": dom.toAriaBoolean(this.disabled), "aria-label": this.label, class: "container", role: role }, index.h("slot", { onSlotchange: this.updateItemsOnSlotChange, ref: (el) => (this.slotRefEl = el) })))));
    }
