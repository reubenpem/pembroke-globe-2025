...
const TabNav = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { role: "tablist" }, index.h("div", { class: {
            ...
            ref: this.storeContainerRef }, this.renderScrollButton("start"), index.h("div", { class: {
                [CSS$1.tabTitleSlotWrapper]: true,
            }, onScroll: this.onTabTitleScroll, onWheel: this.onTabTitleWheel,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.storeTabTitleWrapperRef }, index.h("slot", { onSlotchange: this.onSlotChange })), index.h("div", { class: {
