...
const resources = require('./resources-661dfdf1.js');
...
const TableHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("th", { "aria-colindex": this.parentRowType === "head" ? this.positionInRow : undefined, class: {
